...
const LandingPage = () => {
  ...
  return (
    <div className="w-full min-h-full bg-white">
        ...
        {/* Header */}
            ...
            <div className="flex flex-col md:flex-row items-center">
                <div className="w-full md:w-1/2 pr-4 mb-8 md:mb-0">
                    ...
                    <p className="text-lg tet-gray-700 mb-8">
                        Craft a standout resume in minutes with this smart and intuitive resume builder.
                    </p>
                    <button     
                        className="bg-black text-sm font-semibold text-white px-8 py-3 rounded-lg hover:bg-gray-800 transition-color cursor-pointer"
                        onClick={handleCTA}
                    >
                        Get Started
                    </button>
            ...
            <section className="mt-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="bg-gray-50 p-6 rounded-xl shadow-sm hover:hadow-md trasition">
        ...
        <div className="text-sm bg-gray-50 text-secondary p-5 mt-5 text-center">
